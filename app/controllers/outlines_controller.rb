class OutlinesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @outline.save
        format.html { redirect_to outlines_url, notice: 'Outline was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @outline.update(outline_params)
        format.html { redirect_to outlines_url, notice: 'Outline was successfully updated.' }
